...
namespace GuarderiaAppWeb.Controllers
{
    public class NinoController : Controller
    {
        ...
        public NinoController(GuarderiaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Matricula,Nombre,Apellido,FechaNacimiento,FechaIngreso,FechaSalida")] nino nino)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Matricula,Nombre,Apellido,FechaNacimiento,FechaIngreso,FechaSalida")] nino nino)
        {
            if (id != nino.Matricula)
            {
                return NotFound();
            }
        ...
        {
            return _context.Ninos.Any(e => e.Matricula == id);
        }
    }
}
